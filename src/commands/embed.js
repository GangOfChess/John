const { SlashCommandBuilder, Client, CommandInteraction, ModalBuilder, ActionRowBuilder, TextInputBuilder, TextInputStyle, EmbedBuilder, Colors } = require("discord.js");
    ...
    run: async(client, interaction) => {
        interaction.showModal(
            new ModalBuilder()
                ...
                .setComponents(["Title", "Description"].map(r => {
